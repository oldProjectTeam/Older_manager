...
(function ($) {
    ...
    $.fn.datebox.defaults = $.extend({}, $.fn.combo.defaults, {
        ...
        }, currentText: "Today", closeText: "Close", cleanText: "Clean", okText: "Ok", buttons: [{
            text: function (_9891) {
                return $(_9891).datebox("options").cleanText;
            }, handler: function (_9901) {
                $(_9901).combo('setValue', '').combo('setText', '');
...
(function ($) {
    ...
    $.fn.datetimebox.defaults = $.extend({}, $.fn.datebox.defaults, {
        spinnerWidth: "100%", showSeconds: true, timeSeparator: ":", keyHandler: {
            ...
            text: function (_9a81) {
                return $(_9a81).datetimebox("options").cleanText;
            },
            handler: function (_9a91) {
                $(_9a91).combo('setValue', '').combo('setText', '');
                $(this).closest("div.combo-panel").panel("close");
            }
        }, {
            text: function (_a6b) {
