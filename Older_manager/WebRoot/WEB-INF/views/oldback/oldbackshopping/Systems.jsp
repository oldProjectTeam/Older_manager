...
<meta http-equiv="Cache-Control" content="no-siteapp" />
 <link href="${APP_PATH}/static/shop/assets/css/bootstrap.min.css" rel="stylesheet" />
        ...
        <script src="${APP_PATH}/static/shop/assets/js/jquery-ui-1.10.3.custom.min.js"></script>
		<script src="${APP_PATH}/static/shop/assets/js/jquery.ui.touch-punch.min.js"></script>
