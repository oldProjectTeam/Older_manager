					...
					<div class="wrap-list">
						<div class="m-user">
							...
							<div class="m-userproperty">
								...
								<p class="m-bonus">
									<a href="bonus.html"> <i><img
											src="${APP_PATH}/static/images/bonus.png" /></i> <span
										class="m-title">红包</span> <em class="m-num">2</em>
									</a>
								</p>
								<p class="m-coupon">
									<a href="coupon.html"> <i><img
											src="${APP_PATH}/static/images/coupon.png" /></i> <span
										class="m-title">优惠券</span> <em class="m-num">2</em>
									</a>
								</p>
								<p class="m-bill">
									<a href="bill.html"> <i><img
											src="${APP_PATH}/static/images/wallet.png" /></i> <span
										class="m-title">钱包</span> <em class="m-num">2</em>
									</a>
								</p>
								<p class="m-big">
									<a href="#"> <i><img
											src="${APP_PATH}/static/images/day-to.png" /></i> <span
										class="m-title">签到有礼</span>
									</a>
								</p>
								<p class="m-big">
									<a href="#"> <i><img
											src="${APP_PATH}/static/images/72h.png" /></i> <span
						...
						<div class="new-goods-info">
							<a class="shop-info" href="#" target="_blank">
								<div class="face-img-panel">
									<img src="${APP_PATH}/static/images/imgsearch1.jpg" alt="">
