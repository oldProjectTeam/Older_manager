  ...
  <body>
    <div style="width:98%;margin-left:4px">
    	<ul class="list-unstyle list-inline nav nav-tabs" style="margin-top:10px">
    		<li style="font-size:20px;"><a href="/Older_manager/static/workmanage/page/addressbookmanager.jsp">老人</a></li>
    		<li class="active" style="font-size:20px;"><a href="/Older_manager/static/workmanage/page/clanaddressmanager.jsp">亲属</a></li>
    	</ul>
    	<div>
