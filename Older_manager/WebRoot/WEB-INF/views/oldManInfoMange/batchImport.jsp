...
<html>
  ...
  <body>
    ...
    <div class="container">
    	<form action="old/addOldManBatch" method="post" enctype="multipart/form-data" id="importBatchForm"
    	>
    	<div class="row">
		  ...
		  <div class="col-md-4 col-md-offset-5">
		  	<button type="button" class="btn btn-success" id="importBatch">批量导入</button><br/><br/>
		  	<font color="blue" id="msg">${msg}</font>
		  	<span></span>
		  </div>
		</div>
    	</form>
