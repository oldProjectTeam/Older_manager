...
public interface ProductsViewsMapper {
    ...
    int updateByExampleSelective(@Param("record") ProductsViews record, @Param("example") ProductsViewsExample example);

    int updateByExample(@Param("record") ProductsViews record, @Param("example") ProductsViewsExample example);
