                            ...
                            <div class="main-content">
                                ...
                                <div class="main-body">
                                    <ul>                          
                                        ...
                                        <li><a href="${APP_PATH}/older/jiuzhen"><i class="icon-nav2 icon-jzjl"></i>就诊记录</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="main-content">
                                ...
                                <div class="main-body" style="height:241px;">
                                    <ul class="ul-bmfw">
                                        <li><a href="${APP_PATH}/older/myactivity"><i class="icon-nav2 icon-fwyd2"></i><div class="li-title">我的活动</div><p>我参与哪些活动了呢</p></a></li>
                                        <li><a href="${APP_PATH}/older/recomActivity"><i class="icon-nav2 icon-ydjl"></i><div class="li-title">推荐活动</div><p>我们给您推荐活动啦</p></a></li>
