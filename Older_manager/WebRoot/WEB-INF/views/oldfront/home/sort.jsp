...
<link href="${APP_PATH}/static/css/demo.css" rel="stylesheet"
	type="text/css" />
<link href="${APP_PATH}/static/css/sortstyle.css" rel="stylesheet"
	type="text/css" />
				...
				<div class="category">
					<ul class="category-list" id="js_climit_li">
										...
										<div class="menu-srot">
											...
											<div class="brand-side">
												<dl class="dl-sort">
													...
													<img src="${APP_PATH}/static/images/TJ.jpg">
												</dl>
											</div>
						...
						<li class="appliance js_toggle relative">
							<div class="category-info">
								<h3 class="category-name b-category-name">
									<i><img src="${APP_PATH}/static/images/cookies.png"></i><a
						...
						<li class="appliance js_toggle relative">
							<div class="category-info">
								<h3 class="category-name b-category-name">
									<i><img src="${APP_PATH}/static/images/meat.png"></i><a
						...
						<li class="appliance js_toggle relative">
							<div class="category-info">
								<h3 class="category-name b-category-name">
									<i><img src="${APP_PATH}/static/images/bamboo.png"></i><a
						...
						<li class="appliance js_toggle relative">
							<div class="category-info">
								<h3 class="category-name b-category-name">
									<i><img src="${APP_PATH}/static/images/nut.png"></i><a
						...
						<li class="appliance js_toggle relative">
							<div class="category-info">
								<h3 class="category-name b-category-name">
									<i><img src="${APP_PATH}/static/images/candy.png"></i><a
						...
						<li class="appliance js_toggle relative">
							<div class="category-info">
								<h3 class="category-name b-category-name">
									<i><img src="${APP_PATH}/static/images/chocolate.png"></i><a
						...
						<li class="appliance js_toggle relative">
							<div class="category-info">
								<h3 class="category-name b-category-name">
									<i><img src="${APP_PATH}/static/images/fish.png"></i><a
						...
						<li class="appliance js_toggle relative">
							<div class="category-info">
								<h3 class="category-name b-category-name">
									<i><img src="${APP_PATH}/static/images/tea.png"></i><a
						...
						<li class="appliance js_toggle relative last">
							<div class="category-info">
								<h3 class="category-name b-category-name">
									<i><img src="${APP_PATH}/static/images/package.png"></i><a
