  ...
  <div class="brand_info clearfix">
   ...
   <form>
    <ul class="Info_style clearfix">
      ...
      <li><label class="label_name">添加时间：</label><span class="name"><fmt:formatDate value="${brand.addtime}" pattern='yyyy-MM-dd HH:mm:ss'/></span></li>
      <li><label class="label_name">状&nbsp;&nbsp;&nbsp;&nbsp;态：</label><span class="name">${brand.state==1?'启用':'停用'}</span></li>
      <li class="b_Introduce">
         <label class="label_name">品牌介绍：</label>
         <span class="name">${brand.description }你的vad女大女警的女警的vAV呢看来你打开v的v的DVD看v打开DVD看看代表康复设备刷副本的vsd看v发送报名费不分胜负泊松分布
         v的的v买了的书吗V领法律没事了的v买的浪费</span>
      </li>
    </ul>
    <div class="brand_logo">
      <img src="upload/152.jpg"  width="120px" height="60px"/>
