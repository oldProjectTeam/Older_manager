...
<link href="${APP_PATH}/static/AmazeUI-2.4.2/assets/css/amazeui.css"
	rel="stylesheet" type="text/css" />
<link href="${APP_PATH}/static/AmazeUI-2.4.2/assets/css/admin.css"
	rel="stylesheet" type="text/css" />
<link href="${APP_PATH}/static/basic/css/demo.css" rel="stylesheet"
	type="text/css" />
<link href="${APP_PATH}/static/css/hmstyle.css" rel="stylesheet"
	type="text/css" />
<link href="${APP_PATH}/static/css/skin.css" rel="stylesheet"
	type="text/css" />
<script src="${APP_PATH}/static/AmazeUI-2.4.2/assets/js/jquery.min.js"></script>
<script src="${APP_PATH}/static/AmazeUI-2.4.2/assets/js/amazeui.min.js"></script>
</head>
<body>
	<div class="hmtop">
		<!-- 顶部导航条 -->
		...
		<div class="container">
			<div class="navbar-header">
				<a class="navbar-brand" href="#">老人管理系统</a>
			</div>
			<div id="navbar">
				<ul class="nav navbar-nav pull-right">
					<li role="presentation"><a href="#">首页</a></li>
					<li role="presentation"><a href="#about">关于我们</a></li>
					<li role="presentation" class="active"><a href="#contact">购物商城</a>
					</li>
					<li role="presentation"><a href="#contact">咨询服务</a></li>
					<li role="presentation"><a href="#contact">会员登陆</a></li>
					<li role="presentation"><a href="#contact">客户端下载</a></li>
					<li role="presentation"><a href="#contact">视频直播</a></li>
					<li role="presentation"><a href="community_activity.html">社区活动</a>
					</li>
				</ul>
			</div>
		</div>
	...
	<div class="container">
			...
			<div class="am-slider am-slider-default scoll" data-am-flexslider
				...
				<ul class="am-slides">
					<li class="banner1"><a href="introduction.html"><img
							src="${APP_PATH}/static/${APP_PATH}/static/images/ad1.jpg" /></a></li>
					<li class="banner2"><a><img
							src="${APP_PATH}/static/${APP_PATH}/static/images/ad2.jpg" /></a></li>
					<li class="banner3"><a><img
							src="${APP_PATH}/static/${APP_PATH}/static/images/ad3.jpg" /></a></li>
					<li class="banner4"><a><img
							src="${APP_PATH}/static/${APP_PATH}/static/images/ad4.jpg" /></a></li>
				</ul>
			</div>
			<div class="clear"></div>
		</div>
									...
									<li class="appliance js_toggle relative first">
										<div class="category-info">
											<h3 class="category-name b-category-name">
												<i><img
													src="${APP_PATH}/static/${APP_PATH}/static/images/cake.png"></i>
													...
													<div class="menu-srot">
														<div class="sort-side">
															<dl class="dl-sort">
																...
																<dd>
																	<a title="增强免疫力" href="#"><span>增强免疫力</span></a>
																</dd>
																<dd>
																	<a title="肠胃消化" href="#"><span>肠胃消化</span></a>
																</dd>
																<dd>
																	<a title="辅助改善记忆力" href="#"><span>辅助改善记忆力</span></a>
																</dd>
																<dd>
																	<a title="辅助降血压" href="#"><span>辅助降血压</span></a>
																</dd>
																<dd>
													...
													<div class="menu-srot">
														<div class="sort-side">
															<dl class="dl-sort">
																...
																<dd>
																	<a title="感冒药" href="#"><span>感冒药</span></a>
																</dd>
																<dd>
																	<a title="退烧药" href="#"><span>退烧药</span></a>
																</dd>
																<dd>
																	<a title="胃药" href="#"><span>胃药</span></a>
																</dd>
																<dd>
																	<a title="止泻药" href="#"><span>止泻药</span></a>
																</dd>
																<dd>
																	<a title="安眠药" href="#"><span>安眠药</span></a>
																</dd>
															</dl>
														</div>
														<div class="brand-side">
									...
									<li class="appliance js_toggle relative first">
										<div class="category-info">
											<h3 class="category-name b-category-name">
												<i><img
													src="${APP_PATH}/static/${APP_PATH}/static/images/cake.png"></i>
												<a class="ml-22" title="器械/器材">器械/器材</a>
											</h3>
											<em>&gt;</em>
										</div>
										<div class="menu-item menu-in top">
													...
													<div class="menu-srot">
														<div class="sort-side">
															<dl class="dl-sort">
																...
																<dd>
																	<a title="体温计" href="#"><span>体温计</span></a>
																</dd>
																<dd>
																	<a title="血压计" href="#"><span>血压计</span></a>
																</dd>
																<dd>
																	<a title="血糖分析仪" href="#"><span>血糖分析仪</span></a>
																</dd>
																<dd>
																	<a title="医用脱脂纱布" href="#"><span>医用脱脂纱布</span></a>
																</dd>
																<dd>
																	<a title="医用脱脂棉" href="#"><span>医用脱脂棉</span></a>
																</dd>
																<dd>
																	<a title="磁疗器具" href="#"><span>磁疗器具</span></a>
																</dd>
																<dd>
																	<a title="轮椅" href="#"><span>轮椅</span></a>
																</dd>
																<dd>
																	<a title="避孕套" href="#"><span>避孕套</span></a>
																</dd>
															</dl>
															<dl class="dl-sort">
																<dt>
																...
																<dd>
																	<a title="握力器" href="#"><span>握力器</span></a>
																</dd>
																<dd>
																	<a title="哑铃" href="#"><span>哑铃</span></a>
																</dd>
																<dd>
																	<a title="曲柄杠铃" href="#"><span>曲柄杠铃</span></a>
																</dd>
																<dd>
																	<a title="弹簧拉力器" href="#"><span>弹簧拉力器</span></a>
																</dd>
																<dd>
									...
									<li class="appliance js_toggle relative first">
										<div class="category-info">
											<h3 class="category-name b-category-name">
												<i><img
													src="${APP_PATH}/static/${APP_PATH}/static/images/cake.png"></i>
												<a class="ml-22" title="生活用品">生活用品</a>
											</h3>
											<em>&gt;</em>
										</div>
										<div class="menu-item menu-in top">
													...
													<div class="menu-srot">
														<div class="sort-side">
															<dl class="dl-sort">
																...
																<dd>
																	<a title="毯子" href="#"><span>毯子</span></a>
																</dd>
																<dd>
																	<a title="凉席" href="#"><span>凉席</span></a>
																</dd>
																<dd>
																	<a title="蚊帐" href="#"><span>蚊帐</span></a>
																</dd>
																<dd>
																	<a title="被褥" href="#"><span>被褥</span></a>
																</dd>
																<dd>
																	<a title="枕芯" href="#"><span>枕芯</span></a>
																</dd>
																<dd>
																	<a title="床上四件套" href="#"><span>床上四件套</span></a>
																</dd>
															</dl>
															<dl class="dl-sort">
																<dt>
																...
																<dd>
																	<a title="不粘锅" href="#"><span>不粘锅</span></a>
																</dd>
																<dd>
																	<a title="刀具" href="#"><span>刀具</span></a>
																</dd>
																<dd>
																	<a title="碗/盘子" href="#"><span>碗/盘子</span></a>
																</dd>
																<dd>
																	<a title="筷子/勺子/叉子/餐刀" href="#"><span>筷子/勺子/叉子/餐刀</span></a>
																</dd>
																<dd>
																	<a title="粘钩" href="#"><span>粘钩</span></a>
																</dd>
																<dd>
																	<a title="杯子" href="#"><span>杯子</span></a>
																</dd>
															</dl>
															<dl class="dl-sort">
																<dt>
																...
																<dd>
																	<a title="头部护理" href="#"><span>头部护理</span></a>
																</dd>
																<dd>
																	<a title="脸部护理" href="#"><span>脸部护理</span></a>
																</dd>
																<dd>
																	<a title="身部护理" href="#"><span>身部护理</span></a>
																</dd>
																<dd>
																	<a title="洗漱用品" href="#"><span>洗漱用品</span></a>
																</dd>
																<dd>
																	<a title="纸品类" href="#"><span>纸品类</span></a>
																</dd>
																<dd>
																	<a title="盆/晾衣架" href="#"><span>盆/晾衣架</span></a>
																</dd>
															</dl>
														</div>
														<div class="brand-side">
									...
									<li class="appliance js_toggle relative first">
										<div class="category-info">
											<h3 class="category-name b-category-name">
												...
												<a class="ml-22" title="首饰/服装">首饰/服装</a>
											</h3>
											<em>&gt;</em>
										</div>
										<div class="menu-item menu-in top">
													...
													<div class="menu-srot">
														<div class="sort-side">
															<dl class="dl-sort">
																...
																<dd>
																	<a title="头饰" href="#"><span>头饰</span></a>
																</dd>
																<dd>
																	<a title="耳饰" href="#"><span>耳饰</span></a>
																</dd>
																<dd>
																	<a title="颈饰" href="#"><span>颈饰</span></a>
																</dd>
																<dd>
																	<a title="手饰" href="#"><span>手饰</span></a>
																</dd>
																<dd>
																	<a title="胸饰" href="#"><span>胸饰</span></a>
																</dd>
																<dd>
																	<a title="腰饰" href="#"><span>腰饰</span></a>
																</dd>
																<dd>
																	<a title="挂饰" href="#"><span>挂饰</span></a>
																</dd>
																<dd>
																	<a title="披肩/围巾" href="#"><span>披肩/围巾</span></a>
																</dd>
															</dl>
															<dl class="dl-sort">
																<dt>
																...
																<dd>
																	<a title="裙子" href="#"><span>裙子</span></a>
																</dd>
																<dd>
																...
																<dd>
																	<a title="外套" href="#"><span>外套</span></a>
																</dd>
																<dd>
																	<a title="鞋子" href="#"><span>鞋子</span></a>
																</dd>
															</dl>
														</div>
														<div class="brand-side">
					...
					<div class="am-u-sm-4 am-u-lg-3 ">
						...
						<div class="recommendationMain one">
							<a href="introduction.html"><img
								src="${APP_PATH}/static/images/tj.png "></img></a>
						</div>
					</div>
					<div class="am-u-sm-4 am-u-lg-3 ">
						<div class="info ">
		...
		<div class="navCir">
			...
			<li><a href="${APP_PATH}/static/person/index.html"><i
		...
		<script type="text/javascript "
			src="${APP_PATH}/static/basic/js/quick_links.js "></script>
