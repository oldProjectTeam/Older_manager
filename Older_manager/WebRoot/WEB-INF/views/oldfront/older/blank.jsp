        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="min-height:500px;">
                <div class="alert alert-info">
                    This is  an blank page which you can customize easily and for more free templates keep looking<a href="http://www.cssmoban.com/"  target="_blank" > binarytheme.com</a>.
