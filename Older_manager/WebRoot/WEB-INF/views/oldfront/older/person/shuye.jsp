...
<div class="jksj" style="margin-top:15px;">
                      ...
                      <button type="button" class="btn back fr" id="btnclose">返回</button>
                                            ...
                                            <div class="col-md-6 col-md-offset-2">
                                                <form class="form-horizontal " role="form">
                                                    <div class="form-group">
                                                        <label for="" class="col-md-4 control-label">输血原因：</label>
                                                        <div class="col-md-8" style="padding:0;">
                                                            <input type="text" class="form-control" id="yaoname" placeholder=""></div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="" class="col-md-4 control-label">输血量：</label>
                                                        <div class="col-md-8" style="padding:0;">
                                                            <input type="text" class="form-control" id="zuoyong" placeholder=""></div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="" class="col-md-4 control-label">治疗时间：</label>
                                                        <input class="easyui-datebox datebox-f combo-f textbox-f" editable="false" id="h_kaishi" style="width: 280px; height: 30px; display: none;"> 
                                                    </div>
                                                     
                                                    <div class="form-group">
                                                        <label for="" class="col-md-4 control-label">备注：</label>
                                                        <div class="col-md-8" style="padding:0;">
                                                            <input type="text" class="form-control" id="jiliang" placeholder=""></div>
                                                    </div>
                        ...
                        <table class="table table-striped table-bordered table-hover text-center yyjl-table">
                            ...
                            <tbody>
                             <tr>
                               ...
                               <td>恢复良好</td>
                               <td>
                                 <div class="jjda-btn " data-toggle="modal" data-target="#jkda" ><i class="jjda-btn-editer"></i>编辑
                                 </div>
                                 <div class="jjda-btn " onclick="del()"><i class="jjda-btn-del"></i>删除
                                 </div>
                                </td>
                               </tr>
                            </tbody>
                        ...
                        <nav>
                            ...
                            <li class="disabled"><a href="#">&lt;</a></li> <li><a href="http://demo.shecuntong.cn/DynaForm/174/821#">1</a></li><li><a href="http://demo.shecuntong.cn/DynaForm/174/821#">&gt;</a></li></ul>
                        </nav>
                        <!-- 列表结束 -->
                    </div>
                    <!-- 健康数据结束 -->
