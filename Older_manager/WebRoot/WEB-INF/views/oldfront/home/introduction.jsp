...
<body>
		...
		<ul class="message-r">
			...
			<div class="topMessage my-shangcheng">
				<div class="menu-hd MyShangcheng">
					<a href="shop/index" target="_top"> <i
			...
			<div class="topMessage mini-cart">
				<div class="menu-hd">
					<a id="mc-menu-hd" href="${APP_PATH}/shop/shopcart" target="_top">
	...
	<div class="nav white">
		...
		<div class="logoBig">
			<li><img src="${APP_PATH}/static/images/oldback/images/logo.png"
				height="85px;" /></li>
		</div>
					...
					<ul class="tb-thumb" id="thumblist">
						<li class="tb-selected">
							<div class="tb-pic tb-s40">
								<a href="#"><img
									src="${APP_PATH}/static/images/01_small.jpg"
									mid="${APP_PATH}/static/images/01_mid.jpg"
									big="${APP_PATH}/static/images/01.jpg"></a>
							</div>
						</li>
						<li>
							<div class="tb-pic tb-s40">
								<a href="#"><img
									src="${APP_PATH}/static/images/02_small.jpg"
									mid="${APP_PATH}/static/images/02_mid.jpg"
									big="${APP_PATH}/static/images/02.jpg"></a>
							</div>
						</li>
						<li>
							<div class="tb-pic tb-s40">
								<a href="#"><img
									src="${APP_PATH}/static/images/03_small.jpg"
									mid="${APP_PATH}/static/images/03_mid.jpg"
									big="${APP_PATH}/static/images/03.jpg"></a>
							</div>
						</li>
					</ul>
				</div>
