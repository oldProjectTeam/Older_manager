...
<body>
	...
	<div style="width:98%;margin-left:10px">
		...
		<form class="form-inline" id="activity_data_form">
			...
			<div class="form-group">
				<label for="exampleInputName2">活动地点</label> <input type="text"
					class="form-control" id="place" name="place" placeholder="活动地点">
			</div>
			<div class="form-group">
				<label for="exampleInputName2">发布部门</label> <input type="text"
					class="form-control" id="releasepeople" name="releasepeople"
					placeholder="发布部门">
			</div>
			<div class="form-group">
				<label for="exampleInputName2">活动时间</label> <input type="date"
					class="form-control" id="activitytime" name="activitytime"
					placeholder="活动时间">
			</div>
			<div class="form-group">
				<label for="exampleInputName2">活动内容：</label><br>
				<textarea rows="12" cols="129" placeholder="活动的内容"
					style="margin-top:10px;margin-bottom:10px" id="content"
				...
				.mouseleave(
						function() {
							...
							if (!regex.test(releasepeople)) {
								...
								$("#releasepeople").attr("releasepeople_check",
										"fail");
