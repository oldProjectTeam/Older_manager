...
public class IntegralServiceImplTest {
	...
	public void testQueryAllIntegral() {
		...
		Integral integral=new Integral();
 		...
 		integral.setChangetime1(new Date(2017-10-1));
 		
 		integral.setChangetime2(new Date());
		...
		for(Integral i:integrals){
			System.out.println("id:"+i.getId()+" 姓名："+i.getOldman().getName()+" 当前积分："+i.getCurrentintegral());
		}
	}
