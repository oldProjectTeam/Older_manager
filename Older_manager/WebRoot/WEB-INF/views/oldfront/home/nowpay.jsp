											...
											<li class="td td-item">
												<div class="item-pic">
													<a href="#" class="J_MakePoint"
														title="${product.imagetitle}"> <img
														src="${APP_PATH}/${product.images}"
				...
				<div class="pay-confirm clearfix">
								...
								<c:if test="${address.state==1}">
									...
									<p class="buy-footer-address">
										<span class="buy-line-title">收货人：</span> <span
											class="buy-address-detail"> <span class="buy-user">${address.name}</span>
					...
					<div id="holyshit269" class="submitOrder">
						<div class="go-btn-wrap">
							<a id="J_Go" href="javascript:;" onClick="submitOrder(2)"
	...
	<script type="text/javascript">
		...
		$(document).on(
				...
				function() {
					...
					//该商品总金额
					var baseprice = num * nowprice+'${product.paral11}';
