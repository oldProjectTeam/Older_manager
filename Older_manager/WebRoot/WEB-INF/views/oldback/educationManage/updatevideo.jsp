...
<body style="margin: 15px;">
	...
	<div class="row">
		<div class="col-md-12">
			<ol class="breadcrumb">
				...
				<li><b><a
						href="static/oldback/educationManage/videoManager.jsp">视频管理</a></b></li>
						...
						<tbody>
							<tr>
								...
								<td class="col-xs-2"><input type="text"
									class="form-control" required="required" value="${video.title}"
									name="title" id="title"></td>
								<td>副标题 <span style="color:red">*</span></td>
								<td class="col-xs-2"><input type="text"
									class="form-control" value="${video.subtitle}"
									required="required" name="subtitle" id="subtitle"></td>
								<td>创作人 <span style="color:red">*</span></td>
								<td class="col-xs-2"><input type="text"
									class="form-control" name="creators" value="${video.creators}"
									id="creators"></td>
								<td rowspan="1" class="active">视频 <span style="color:red">*</span></td>
								<td rowspan="1" class="col-xs-2"><input type="hidden"
									id="videopath" name="path" value="${video.path}" /> <input
									class="btn btn-default" type="file" id="video"
									value="${video.path}" onchange="showPic()"></td>
							</tr>
							<tr>
								<td>视频描述</td>
								...
								<td><input type="text" class="form-control"
									value="${video.director}" name="director"></td>
								<td>制作者</td>
								<td><input type="text" class="form-control"
									value="${video.producer}" name="producer"></td>

							</tr>
							<tr>
								<td>版权</td>
								<td><input type="text" class="form-control"
									value="${video.copyright}" name="copyright"></td>
								<td>内容提供商</td>
								<td><input type="text" class="form-control"
									value="${video.contentprovider}" name="contentprovider"></td>
								<td>创建时间 <span style="color:red">*</span></td>
								<td><input type="date" class="form-control"
									name="createtime" id="createtime"></td>
								<td colspan="2"><video src="${video.path}"
										controls="controls" class="img-responsive" poster="" />
							...
							<tr>
								...
								<td><input type="text" class="form-control"
									required="required" name="lenght" value="${video.lenght}"
									id="lenght"></td>
								<td>帧高度</td>
								<td><input type="text" class="form-control"
									value="${video.frameheight}" name="frameheight"></td>
								<td colspan="2"><input class="btn btn-success"
									type="button" value="上传视频" name="addvideo"
									onclick="uploadFile()">
									<div id="progress" class="progress-bar"
										style=" margin-top: 20 "></td>
							</tr>
							<tr>
								<td>标记</td>
								<td><input type="text" class="form-control"
									value="${video.marking}" name="marking"></td>
								<td>数据速率</td>
								<td>
									<div class="form-group">
										<div class="col-sm-8">
											<input type="text" class="form-control"
												value="${video.daterate}" name="daterate">
										</div>
								...
								<td>
									<div class="form-group">
										<div class="col-sm-8">
											<input type="text" class="form-control"
												value="${video.totalbitrate}" name="totalbitrate">
										</div>
										<label class="col-sm-1 control-label">kbps</label>
									</div>
								</td>
								...
								<td>
									<div class="form-group">
										<div class="col-sm-7">
											<input type="text" class="form-control"
												value="${video.framerate}" name="framerate">
										</div>
							...
							<tr>
								<td>频道</td>
								<td><input type="text" class="form-control"
									value="${video.channel}" name="channel"></td>
								<td>音频采样频率</td>
								<td>
									<div class="form-group">
										<div class="col-sm-8">
											<input type="text" class="form-control" value="${video.afsf}"
												name="afsf">
										</div>
								...
								<td>
									<div class="form-group">
										<div class="col-sm-8" name="">
											<input type="text" class="form-control"
												value="${video.bitrate}" name="bitrate">
										</div>
										<label class="col-sm-1 control-label">kbps</label>
									</div>
								</td>
								<td>帧宽度</td>
								<td><input type="text" class="form-control"
									value="${video.framewidth}" name="framewidth"></td>
							</tr>
							<tr>
	...
	<script type="text/javascript">
		...
		window.onload = function() {
			document.getElementById("createtime").valueAsDate = new Date(
					"${video.createtime}");
		};
