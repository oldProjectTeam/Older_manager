						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="main-content">
									...
									<div class="main-body">
										<ul>
											<li><a href="health.html"> <i
													class="icon-nav2 icon-jksj2"> </i>健康数据
											</a></li>
											<li><a
												href="${APP_PATH}/static/oldfront/older/person/pinggu.jsp"><i
													class="icon-nav2 icon-yjsz"></i>健康评估</a></li>
											<li><a
												href="${APP_PATH}/static/oldfront/older/person/lvli.jsp"><i
													class="icon-nav2 icon-jkda"></i>健康履历</a></li>
											<li><a
												href="${APP_PATH}/static/oldfront/older/person/takeDrug.jsp"><i
													class="icon-nav2 icon-yyjl"></i>用药记录</a></li>
											<li><a
												href="${APP_PATH}/static/oldfront/older/person/tijian.jsp"><i
													class="icon-nav2 icon-tjjl"></i>体检记录</a></li>
											<li><a
												href="${APP_PATH}/static/oldfront/older/person/jiuzhen.jsp"><i
													class="icon-nav2 icon-jzjl"></i>就诊记录</a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="col-md-6">
								<div class="main-content">
									...
									<div class="main-body" style="height:241px;">
										<ul class="ul-bmfw">
											<li><a
												href="${APP_PATH}/static/oldfront/older/person/myactivity.jsp"><i
													class="icon-nav2 icon-fwyd2"></i>
													<div class="li-title">我的活动</div>
													<p>我参与哪些活动了呢</p></a></li>
											<li><a
												href="${APP_PATH}/static/oldfront/older/person/recomActivity.jsp"><i
													class="icon-nav2 icon-ydjl"></i>
													<div class="li-title">推荐活动</div>
													<p>我们给您推荐活动啦</p></a></li>
							...
							<div class="col-md-6">
								<div class="main-content">
									...
									<div class="main-body">
										<ul class="ul-wzfw">
											<li><a
												href="${APP_PATH}/static/oldfront/older/person/mycourse.jsp"><i
													class="icon-nav2 icon-dwfw"></i>
													<div class="li-title">我的课程</div>
													<p>我参加了哪些课程</p></a></li>
											<li><a
												href="${APP_PATH}/static/oldfront/older/person/allcourse.jsp"><i
													class="icon-nav2 icon-gjhf"></i>
													<div class="li-title">寻找课程</div>
													<p>所有课程，都在这里</p></a></li>
											<li><i class="icon-nav2"></i>
