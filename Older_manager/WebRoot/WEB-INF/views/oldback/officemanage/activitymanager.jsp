...
<body>
	...
	<div style="width:98%;margin-left:5px">
		...
		<ul class="list-unstyle list-inline">
			<li><a
				href="/Older_manager/static/oldback/officemanage/sendactivity.jsp"><button
						type="button" class="btn btn-default">发布活动</button></a></li>
		...
		<form action="" method="post" class="form-inline">
			...
			活动地点： <select style="width:150px">
				<option>上海</option>
				<option>北京</option>
			</select>&nbsp;&nbsp;&nbsp; 活动时间：<input type="text" placeholder="发布人">&nbsp;&nbsp;&nbsp;
				...
				<td>
					<ul class="list-unstyle list-inline">
						...
						<li class="col-sm-4 text-center"><a
							href="/Older_manager/static/oldback/officemanage/activityinformation.jsp">查看</a></li>
					</ul>
				</td>
			</tr>
			<tr>
		...
		<div style="height:90px">
			跳转至： <select style="width:60px;height:30px">
				<option>1</option>
				<option>2</option>
				<option>3</option>
				<option>4</option>
			</select> &nbsp;页&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;<a href=""><span
					...
					<div class="modal-body">
						<form action="" method="post" class="form-horizontal">
							<div class="form-group">
								&nbsp;&nbsp;&nbsp;&nbsp;活动名称：<input type="text"
									style="width:300px">
							</div>
							<div class="form-group">
								&nbsp;&nbsp;&nbsp;&nbsp;活动时间：<input type="text"
									style="width:300px">
							</div>
							<div class="form-group">
								&nbsp;&nbsp;&nbsp;&nbsp;活动地点：<input type="text"
									style="width:300px">
							</div>
							<div class="form-group">
								&nbsp;&nbsp;&nbsp;&nbsp;发&nbsp;布&nbsp;人&nbsp;：<input type="text"
									style="width:300px">
							</div>
							<div class="form-group">
								&nbsp;&nbsp;&nbsp;&nbsp;活动类型：<input type="text"
									style="width:300px">
							</div>
							<div class="form-group">
								&nbsp;&nbsp;&nbsp;&nbsp;活动状态： <select>
