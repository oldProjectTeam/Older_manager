...
<html>
  <head>
   ...
   <title>商品页面</title>
		...
		<link type="text/css" href="${APP_PATH}/static/css/optstyle.css" rel="stylesheet" />
		<link type="text/css" href="${APP_PATH}/static/css/style.css" rel="stylesheet" />
		<link type="text/css" href="${APP_PATH}/static/css/style.css" rel="stylesheet" />
		
		<script type="text/javascript" src="${APP_PATH}/static/js/jquery-3.2.1.min.js"></script>
		<script type="text/javascript" src="${APP_PATH}/static/js/quick_links.js"></script>

		<script type="text/javascript" src="${APP_PATH}/static/js/amazeui.js"></script>
		<script type="text/javascript" src="${APP_PATH}/static/js/jquery.imagezoom.min.js"></script>
		<script type="text/javascript" src="${APP_PATH}/static/js/jquery.flexslider.js"></script>
				...
				<div class="scoll">
					<section class="slider">
						<div class="flexslider">
							<ul class="slides">
								<li>
									<img src="${APP_PATH}/static/images/01.jpg" title="pic" />
								</li>
								<li>
									<img src="${APP_PATH}/static/images/02.jpg" />
								</li>
								<li>
									<img src="${APP_PATH}/static/images/03.jpg" />
								</li>
							</ul>
						</div>
					</section>
					...
					<div class="clearfixLeft" id="clearcontent">
						...
						<div class="box">
							...
							<div class="tb-booth tb-pic tb-s310">
								<a href="${APP_PATH}/static/images/01.jpg"><img src="${APP_PATH}/static/images/01_mid.jpg" alt="细节展示放大镜特效" rel="${APP_PATH}/static/images/01.jpg" class="jqzoom" /></a>
							</div>
							<ul class="tb-thumb" id="thumblist">
								<li class="tb-selected">
									<div class="tb-pic tb-s40">
										<a href="#"><img src="${APP_PATH}/static/images/01_small.jpg" mid="${APP_PATH}/static/images/01_mid.jpg" big="${APP_PATH}/static/images/01.jpg"></a>
									</div>
								</li>
								<li>
									<div class="tb-pic tb-s40">
										<a href="#"><img src="${APP_PATH}/static/images/02_small.jpg" mid="${APP_PATH}/static/images/02_mid.jpg" big="${APP_PATH}/static/images/02.jpg"></a>
									</div>
								</li>
								<li>
									<div class="tb-pic tb-s40">
										<a href="#"><img src="${APP_PATH}/static/images/03_small.jpg" mid="${APP_PATH}/static/images/03_mid.jpg" big="${APP_PATH}/static/images/03.jpg"></a>
									</div>
								</li>
							</ul>
						</div>
				...
				<!-- <div class="match">
					...
					<div class="match-comment">
						<ul class="like_list">
							<li>
								<div class="s_picBox">
									<a class="s_pic" href="#"><img src="${APP_PATH}/static/images/cp.jpg"></a>
							...
							<li>
								<div class="s_picBox">
									<a class="s_pic" href="#"><img src="${APP_PATH}/static/images/cp2.jpg"></a>
					    ...
					    <div class="mc"> 
						     <ul>					    
						     	<div class="mt">            
							      ...
							      <li class="first">
							      	<div class="p-img">                    
							      		<a  href="#"> <img class="" src="${APP_PATH}/static/images/browse1.jpg"> </a>               
							      	</div>
								...
								<div class="am-tab-panel am-fade am-in am-active">
									...
									<div class="details">
										...
										<div class="twlistNews">
											<img src="${APP_PATH}/static/images/tw1.jpg" />
											<img src="${APP_PATH}/static/images/tw2.jpg" />
											<img src="${APP_PATH}/static/images/tw3.jpg" />
											<img src="${APP_PATH}/static/images/tw4.jpg" />
											<img src="${APP_PATH}/static/images/tw5.jpg" />
											<img src="${APP_PATH}/static/images/tw6.jpg" />
											<img src="${APP_PATH}/static/images/tw7.jpg" />
										</div>
									</div>
									<div class="clear"></div>
						...
						<div class="footer">
							...
							<div class="footer-bd">
								<p>
									...
									<a href="#">联系我们</a>
									<a href="#">网站地图</a>
									<em>© 2017-2027 xiaohe.com 版权所有</em>
								</p>
							</div>
						</div>
					</div>
				...
				<div id="sidebar">
					<div id="wrap">
						<div id="prof" class="item">
							<a href="#">
								<span class="setting"><font color=white>我的中心</font></span>
							</a>
