...
public class ActivityController {
	...
	public ModelAndView queryAllActivity(@RequestParam(value = "pn", defaultValue = "1") Integer pn,Activity activity) throws Exception{
		ModelAndView modelAndView=new ModelAndView("/oldback/officemanage/activitymanager");
		
		//设置中文编码格式
		if(activity!=null){
			if(activity.getTitle()!=null)
				activity.setTitle(new String(activity.getTitle().getBytes("ISO-8859-1"),"utf-8"));
			if(activity.getPlace()!=null)
				activity.setPlace(new String(activity.getPlace().getBytes("ISO-8859-1"),"utf-8"));
		}
