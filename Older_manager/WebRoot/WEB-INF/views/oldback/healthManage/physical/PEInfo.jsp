...
<body style="margin: 15px;">
		...
		<div class="row form-inline" align="left" style="margin-top:10px;">
			<div class="col-md-12">
				老人姓名： <input type="text" class="form-control" id=""
					...
					class="form-control" id="" placeholder="请输入体检医院名称"> 
	...
	<SCRIPT type="text/javascript">
		...
		$("#addvedio_btn").click(function() {
			window.location.href = "physical/addPEInfo";
		});
		//修改按钮
		$(".update-btn").click(function() {
			window.location.href = "physical/alterPEInfo";
		});
		//查看按钮
		$(".vedioview-btn").click(function() {
			window.location.href = "physical/selectPEInfo";
		});
	</SCRIPT>
</body>
</html>
