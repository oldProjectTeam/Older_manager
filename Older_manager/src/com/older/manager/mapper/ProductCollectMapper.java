...
public interface ProductCollectMapper {
	...
	int updateByExampleSelective(@Param("record") ProductCollect record,
			@Param("example") ProductCollectExample example);

	int updateByExample(@Param("record") ProductCollect record,
			@Param("example") ProductCollectExample example);
