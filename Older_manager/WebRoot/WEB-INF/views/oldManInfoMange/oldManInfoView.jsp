		   ...
		   <form class="form-horizontal">
			 <table   class="table text-center table-bordered">
				<tr>
					...
					<td rowspan="4">
						 <img src="${APP_PATH}/static/oldback/images/jiahao.jpg" alt="..." class="img-rounded" width="100px">
					</td>					
				</tr>
				<tr>
					<td>联系手机号：</td>
				...
				<tr>
					...
					<td>出生日期：</td>
					<td>
					<fmt:formatDate value="${oldman.birthday}" pattern="yyyy-MM-dd"/>
					</td>
					<td>年龄：</td>
					<td>
					  ${oldman.age}
				...
				<tr>
					<td>经济来源：</td>
					<td>
					   ${oldman.economicsource}
					</td>
					 <td>月收入</td>
					 <td>
					    ${oldman.monthlyincome}
					 </td>
					 <td>医疗保障：</td>
					<td>
					   ${oldman.healthcare} 
