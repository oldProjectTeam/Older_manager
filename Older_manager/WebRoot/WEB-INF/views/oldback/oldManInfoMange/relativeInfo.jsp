			...
			<div class="modal-content">
						...
						<table class="table table-striped table-bordered text-center">
							<tr>
								...
								<td><input type="text" required="required" name="name"
									class="form-control" /> <br> <input type="radio"
							...
							<tr>
								...
								<td>是否同住</td>
								<td><select style="width:70px" name="islive">
										<option>是</option>
										<option>否</option>
								</select></td>
							</tr>
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary"
						id="save_old_relaties_btn">保存</button>
				</div>
			</div>
			<!-- /.modal-content -->
		</div>
						...
						<table class="table table-striped table-bordered text-center">
							<tr>
								...
								<td><p class="form-control-static"
										id="update_old_relatives_name"></p> <br> <input
									type="radio" name="sex" value="男" id="update_old_relatives_boy" />男<input
									type="radio" name="sex" value="女"
									id="update_old_relatives_girl" />女</td>
								<td>联系电话</td>
