...
public class Oldmanaccount {
	...
	public String toString() {
		return "Oldmanaccount [id=" + id + ", oldmanId=" + oldmanId
				+ ", password=" + password + ", account=" + account
				+ ", loginip=" + loginip + ", logintime=" + logintime
				+ ", integral=" + integral + ", logincount=" + logincount
				+ ", oldmanaccount1=" + oldmanaccount1 + ", oldmanaccount2="
				+ oldmanaccount2 + ", oldmanaccount3=" + oldmanaccount3
				+ ", oldmanaccount4=" + oldmanaccount4 + ", usertype="
				+ usertype + "]";
	}
	...
	public void setOldmanaccount1(String oldmanaccount1) {
		this.oldmanaccount1 = oldmanaccount1 == null ? null : oldmanaccount1
				.trim();
	}
	...
	public void setOldmanaccount2(String oldmanaccount2) {
		this.oldmanaccount2 = oldmanaccount2 == null ? null : oldmanaccount2
				.trim();
	}
	...
	public void setOldmanaccount3(String oldmanaccount3) {
		this.oldmanaccount3 = oldmanaccount3 == null ? null : oldmanaccount3
				.trim();
	}
	...
	public void setOldmanaccount4(String oldmanaccount4) {
		this.oldmanaccount4 = oldmanaccount4 == null ? null : oldmanaccount4
				.trim();
	}
