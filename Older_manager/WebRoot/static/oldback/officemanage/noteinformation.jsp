...
<html>
  ...
  <body>
  	<div style="width:98%;margin-left:10px; margin-top:10px">
	    <span>收信人：赵琴琴</span><br>
	    <br>
	    <span>发送内容为：</span>
	    <div style="border:1px solid #F00; margin-top:10px;margin-left:20px;margin-bottom:10px;padding-top:10px;padding-left:10px;width:90%;height:160px">		
	    	爷爷你好：<br>
