...
<script
			...
			<div class="col-main">
				...
				<form class="am-form am-form-horizontal" id="formid">
						...
						<div class="am-form-group">
							...
							<div class="am-form-content">
								<input type="text" id="user-answer1" name="answerone" placeholder="请输入安全问题答案">
							</div>
						</div>
						<div class="am-form-group select">
						...
						<div class="am-form-group">
							...
							<div class="am-form-content">
								<input type="text" id="user-answer2" name="answertwo" placeholder="请输入安全问题答案">
							</div>
						</div>
    ...
    $("#saveid").click(function(){
      ...
      if($("#qu1").val()!='a'){
       if($("#qu2").val()!='a'){
             var kk=/^[\u4E00-\u9FA5A-Za-z0-9]/;
           if($("#user-answer1").val()!=""&&kk.test($("#user-answer1").val())){
              
              if($("#user-answer2").val()!=""&&kk.test($("#user-answer2").val())){
                             var value = 0;
					       var time = 10;
					//进度条复位函数
                         	function reset() {
