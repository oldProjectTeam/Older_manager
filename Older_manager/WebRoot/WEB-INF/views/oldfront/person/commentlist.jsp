...
.item-opinion1{position: relative;left:200px;top: 0px;right:0px;width: auto;max-width:100% ; margin-top:10px;margin-bottom:40px;}
.item-opinion1 li{float:left;margin-left:20px;}
.item-opinion2{position: absolute;left:200px;top: 0px;right:150px;width: auto;max-width:100%  ; margin-top:10px;}

.refund-tip1{position: relative; left:200px; top: 0px;  border:1px dashed #e6e6e6 ; height:100px;width:600px;margin-top:10px;}
.filePic1 {width:100px;padding:10px 10px;position: relative;overflow: hidden;}
.item-pic1 {width: 90px;height: 90px;border: 1px solid #EEE;float: left;overflow: hidden; margin-left:5px;margin-right: 10px;}

.item-comment1{position: relative;left:200px;top: 0px;right:0px;max-width:600px ;margin-top:10px;}

.main-wrap1 {position: relative; margin-left:150px;overflow: hidden;min-height:600px;background-color:#fff;}
</style>
...
<body>
	...
	<b class="line"></b>
	<div class="center">
		<div class="col-main"><!-- 好像也没有关系 -->
			<div class="main-wrap1">

				<div class="user-comment"><!--  没有关系-->
					<!--标题 -->
                   ...
                   <form action="" id="formid" enctype="multipart/form-data">
					<div class="comment-list"><!-- 没有关系 -->
						<c:forEach items="${list}" var="l"> 
						   
							<div class="item-pic1">
								<a href="product/getProduct/${l.producctsId}" class="J_MakePoint">
								 <img src="http://123.207.93.53/Older_back/${l.products.images}" class="itempic J_ItemImg">
							 ...
							 <div class="refund-tip1">
								<div class="filePic1">
									<input type="file" class="inputPic" id="up_img" value="选择凭证图片" name="file" max="5" maxsize="5120" allowexts="gif,jpeg,jpg,png,bmp" accept="image/*">
									 <img src="${pageContext.request.contextPath}/upload/${user.image==null?'image.jpg':user.image}" id="imgShow" class="itempic J_ItemImg"> 
								</div>
						...
						</div><div class="comment-main"><!-- 好像也没有关系 -->
   ...
   window.onload = function() {
    ...
    $("#savebtn").click(function(){
              ...
              if($("#gardeid").val()>0){
               if(($.trim($("#textid").val())!="")){
                $.ajax({
            url:"order/addproductscomment/"+$("#orderid").val(),
            type:"POST",
