  ...
  <!--路劲导航  -->
   ...
   <div >
     <!--操作按钮  -->
  	<div class="row" >
	  <div class="col-md-6">&nbsp;
		 <button type="button" class="btn btn-primary" id="add_old_account_btn">
	  ...
	  <div class="col-md-12">
		 <form class="form-inline">
		  <div class="form-group">
		    ...
		    <input type="text" class="form-control" id="exampleInputName2" placeholder="请输入老人名字">
		  </div>
		  <div class="form-group">
		    <label for="exampleInputEmail2">登录账户</label>
		    <input type="text" class="form-control" id="exampleInputEmail2" placeholder="请输入登录账户">
		  </div>
...
<!--新增账户模态框  -->
<div class="modal fade" tabindex="-1" role="dialog" id="add_old_account_modal">
