 ...
 <script src="${APP_PATH}/static/bootstrap-3.3.7-dist/js/bootstrap.min.js"></script>
  ...
  <!--路劲导航  -->
   ...
   <div >
    ...
    <div class="col-md-12">
             老人姓名： <input type="text" class="form-control"  id="name" placeholder="请输入老人名字">
              身份证号：<input type="text" class="form-control"  id="idcar" placeholder="请输入身份证号">
              联系电话： <input type="text" class="form-control"  id="phone" placeholder="请输入联系电话">
                    性别:
...
<script type="text/javascript">
  ...
  var totalRecord, currentNum,strs="";
		...
		function build_table_data(result) {
            ...
            var olderservice=$("<td></td>").append(item.service);
	...
	$(document).on("click", ".edit_btn", function() {
	            ...
	            var pn=currentNum;
	            window.location.href="${APP_PATH}/old/selectolderwithedit/"+serchid+"&"+pn;
  ...
  $(document).on("click","#check_item_all",function(){
	...
	$("#old_delete_all_btn").click(function(){
		...
		del_idstr=del_idstr.substring(0,del_idstr.length-1);
			...
			//发送ajax请求
		  	 $.ajax({
			url:"${APP_PATH}/old/deleteallolder/"+del_idstr,
			type:"DELETE",
			success:function(result){
				//alert(result.msg);
				//回到当前页面
