...
<body >
  <!--路劲导航  -->
   <div>
	  ...
	  <div class="col-md-12" >
		<ol class="breadcrumb">
		  <li><b>位置：<a href="static/oldback/oldaccountmanage/accountManageindex.html">老人账户管理</a></b></li>
	  ...
	  <div class="col-md-12">
		 <form class="form-inline">
		  <div class="form-group">
		    &nbsp;&nbsp;<label>礼品名称</label>
		    <input type="text" class="form-control" placeholder="请输入礼品名称">
		  </div>
		  <div class="form-group">
		    <label>礼品编号</label>
		    <input type="text" class="form-control" placeholder="请输入礼品编号">
		  </div>
		  <div class="form-group">
		    <label>礼品状态</label>
	  ...
	  <div class="col-md-12">
	    <div class="table-responsive">
		 <table class="table table-hover table-bordered text-center">
		 	...
		 	<tbody>
		 		 <tr>  
		 		 	<td class="text-center"><input type="checkbox" class="gift_item_check"></td>
		 		 	<td>1</td>
		 		 	<td>新大米</td>
		 		 	<td>001</td>
		 		 	<td>粮油</td>
		 		 	...
		 		 	<td>100</td>
		 		 	<td>
		 		 	 <button type="button" class="btn btn-success btn-sm gift_update_btn">
	      ...
	      <div class="modal-body">	        
			    <table class="table-striped table-bordered text-center">
			    	<tr>
			    		...
			    		<input class="btn btn-primary" type="button" value="上传图片"></td>
			    	</tr>
			    	<tr>
			    		<td>礼品编号</td>
			    		<td><input type="text" class="form-control" required="required"></td>			    		
			    	...
			    	<tr>
			    		<td>备注</td>
			    		<td colspan="2"><textarea class="form-control" rows="2" required="required"></textarea></td>			    		
			    	</tr>
			    </table>			     
	      </div>
...
<!--修改礼品模态框  -->
<div class="modal fade" tabindex="-1" role="dialog" id="update_gift_modal">
   <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
