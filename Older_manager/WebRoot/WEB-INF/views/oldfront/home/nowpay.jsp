								...
								<div class="bundle  bundle-last">
									...
									<div class="bundle-main">
										...
										<div class="pay-phone">
											<li class="td td-item">
												<div class="item-pic">
													<a href="#" class="J_MakePoint" title="${product.imagetitle}">
														<img src="${APP_PATH}/${product.images}"
												...
												<div class="item-info">
													<div class="item-basic-info">
														<a href="#" class="item-title J_MakePoint" value="${product.id}" title="${product.name}"
														data-point="tbcart.8.11">${product.name}</a>
													</div>
												</div>
											</li>
											<!-- <li class="td td-info">
										...
										<li class="td td-amount">
											...
											<div class="item-amount ">
												...
												<div class="sl">
													...
													<input class="text_box" name="" type="text" value="${number}" style="width:30px;" />
										...
										<li class="td td-sum">
											<div class="td-inner">
												<em tabindex="0" class="J_ItemSum number">${cost}</em>
											</div>
										</li>
...
function submitOrder(userId){
	...
	//收货地址id
	 ...
	 window.location.href="${APP_PATH}/pay/now_pay.action?shippingaddressId="+addressId+
			 "&formulaway="+formulaWay+
			 "&paytype="+payType+"&pId="+id
...
$(document).on("click",".add",function(){
	...
	$(this).parents("ul").find("em:.number").html(baseprice);

	 
	$("#J_ActualFee").html(baseprice);
	$("#pay-sum").html(baseprice);
