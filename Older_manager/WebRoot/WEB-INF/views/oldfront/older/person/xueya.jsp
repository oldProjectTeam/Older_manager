								...
								<div class="col-md-12">
									<div style="width:100%;height:450px;">
										<div id="main"
											...
											_echarts_instance_="1511227843327"></div>
										<!-- 引入图表-->
									</div>
								</div>
									...
									<div class="modal-content">
											...
											<div class="row">
												<div class="col-md-6 col-md-offset-2">
													<form class="form-horizontal " role="form">
														...
														<div class="form-group ">
															<label for="" class="col-md-4 control-label">高压：</label>
															<div class="input-group col-md-8">
																<input type="text" class="form-control" id="Hsystolic">
																<span class="input-group-addon">mmHg</span>
															</div>
														</div>
														<div class="form-group ">
															<label for="" class="col-md-4 control-label">低压：</label>
															<div class="input-group col-md-8">
																<input type="text" class="form-control" id="Hdiastolic">
																<span class="input-group-addon">mmHg</span>
															</div>
														</div>
														<!--<div class="form-group ">
                                                        <label for="" class="col-md-4 control-label">脉率：</label>
                                                        <div class="input-group col-md-8">
                                                            <input type="text" class="form-control" id="Hpluse">
										...
										<div class="modal-footer">
											<button type="button" class="btn btn-info" onclick="add()"
												data-dismiss="modal" style="background-color: #13c0ab;">保存</button>
							...
							<table
								...
								<thead>
									<tr class="xy-head firstRow">
										...
										<th style="width:20%">高压（mmHg）</th>
										<th style="width:20%">低压（mmHg）</th>
										<!--<th style="width:20%">
                        脉率
                    </th>-->
								...
								<tbody id="shuju">
									<tr style="height:40px">
										<td>2017-11-20 20:00</td>
										<td><em class="icon-xy icon-xy-up"></em>25</td>
										<td><em class="icon-xy icon-xy-down"></em>25</td>
										<td><em></em>正常低值</td>
									</tr>
									<tr style="height:40px">
										<td>2017-11-14 17:32</td>
										<td><em class="icon-xy icon-xy-up"></em>60</td>
										<td><em class="icon-xy icon-xy-down"></em>30</td>
										<td><em></em>正常低值</td>
									</tr>
									<tr style="height:40px">
										<td>2017-11-14 17:31</td>
										<td><em class="icon-xy icon-xy-up"></em>90</td>
										<td><em class="icon-xy icon-xy-down"></em>50</td>
										<td><em></em>正常低值</td>
									</tr>
								</tbody>
							</table>
