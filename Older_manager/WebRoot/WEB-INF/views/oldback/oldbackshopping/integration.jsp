					...
					<tbody>
						<tr>
							...
							<td><a href="javascript:ovid()"
								onclick="integration_history('23')">3434</a></td>
							<td><a href="javascript:ovid()"
								onclick="Browse_history('13')">3434</a></td>
							<td><a href="javascript:ovid()"
								onclick="Order_history('33')">34</a></td>
						...
						<tr>
							...
							<td>花海iatiant</td>
							<td><a href="javascript:ovid()"
								onclick="integration_history('43')">45</a></td>
							<td><a href="javascript:ovid()"
								onclick="Browse_history('53')">11</a></td>
							<td><a href="javascript:ovid()"
								onclick="Order_history('23')">45</a></td>
							<td><a title="删除" href="javascript:;"
						...
						<tr>
							...
							<td>梅毒</td>
							<td><a href="javascript:ovid()"
								onclick="integration_history('5')">45</a></td>
							<td><a href="javascript:ovid()"
								onclick="Browse_history('4')">11</a></td>
