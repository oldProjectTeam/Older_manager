	...
	<div class="row">
		<div class="col-md-12">&nbsp;&nbsp;
		  <div class="table-responsive">
		   <form class="form-horizontal" method="post" action="${APP_PATH}/old/addnewolder">
			 <table   class="table text-center table-bordered">
				<tr>
					<td><font color=red>*</font>老人姓名:</td>
					<td><input type="text" required="required" name="name" style="width:120px"/></td>
					<td><font color=red>*</font>身份证号:</td>
					<td ><input type="text" required="required" name="idcar" style="width:150px"/></td>
				...
				<tr>
					...
					<td><input type="text" required="required" name="phone" style="width:120px"/></td>
					<td>婚姻状况：</td>
					<td>
					  <select style="width:70px" name="marriage">
						<option>已婚</option>
						<option>未婚</option>
						<option>离异</option>
						<option>丧偶</option>
				...
				<tr>
					...
					<td>
					  <input type="text" required="required" name="age"  style="width:120px;"/>
					</td>					
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
					   <input type="text" name="urgencycontact" required="required" style="width:120px"/>
					</td>
					 <td><font color=red>*</font>联系电话：</td>
					 <td><input type="text" name="urgencycontactphone" required="required" style="width:120px"/></td>
					<td>
					  关系：
					</td>
					<td colspan="2" >
				...
				<tr>
					<td>服务类型：</td>
					<td>
					   <select style="width:120px" name="servicetype">
						<option>残联购买</option>
						<option>有偿服务</option>
						<option>政府购买</option>				
					  </select>
					 ...
					 <td>
					    <select style="width:120px" name="servicestatu">
					    <option>请选择</option>
						<option>迁出服务区</option>
						<option>去世</option>
						<option>停止服务</option>
				...
				<tr>
					<td>经济来源：</td>
					<td>
					   <select style="width:120px" name="economicsource">
						<option>出租房子</option>
						<option>社保工资</option>
						<option>子女赡养</option>
						<option>做小生意</option>
					 ...
					 <td>月收入</td>
					 <td>
					    <input type="text" style="width:120px" name="monthlyincome"/>
					 </td>
					 <td>医疗保障：</td>
					<td>
					   <select style="width:120px" class="healthcare">
					...
					<td>社保号</td>
					 <td>
					    <input type="text" style="width:120px" name="socialsecurityno"/>
					 </td>				 					
				</tr>
				<tr>
				...
				<tr>
					<td>慢性病：</td>
					<td>
					   <select style="width:120px" name="chronicdiseases">
						<option>高血压</option>
						<option>高血糖</option>
						<option>无</option>
						<option>其它</option>			
					 ...
					 <td>血型</td>
					 <td>
					    <select style="width:120px" name="bloodtype">
						<option>A型</option>
						<option>B型</option>
						<option>O型</option>
						<option>特殊血型</option>					 		
					 ...
					 <td>失能情况：</td>
					<td>
					   <select style="width:120px" name="disabilitysituation">
						<option>无</option>
						<option>轻度失能</option>
						<option>中度失能</option>
						<option>重度失能</option>						 		
					...
					<td>残疾情况：</td>
					<td>
					   <select style="width:120px" name="disability">
						<option>无</option>
						<option>轻度残疾</option>
						<option>中度残疾</option>
						<option>重度残疾</option>						 		
				...
				<tr>
					<td>文化程度：</td>
					<td>
					   <select style="width:120px" name="educationlevel">
					    <option>硕士</option>
						<option>本科</option>
						<option>专科</option>
						<option>高中</option>
					 ...
					 <td>专业</td>
					 <td>
					    <input type="text" style="width:120px"name="majors"/>
					 </td>
					 <td>职称</td>
					 <td>
					    <input type="text" style="width:120px"name="title"/>
					 </td>
					<td>原单位</td>
					 <td>
					    <input type="text" style="width:120px" name="unitorignal"/>
					 </td>			 					
				</tr>
				<tr>
					<td colspan="8">
