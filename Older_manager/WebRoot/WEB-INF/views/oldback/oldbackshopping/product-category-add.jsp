...
<body>
		...
		<div class="type_content">
			<div class="Operate_btn">
				<a class="btn  btn-warning" id="add_btn"><i
					class="icon-edit align-top bigger-125"></i>新增子类型</a> <a class="btn"
					id="stop_add"><i id="stop_icon" class="align-top bigger-125"></i><span
					id="flag">禁用该类型</span></a>
				<!--  禁用该类型-->
				<a class="btn  btn-danger" id="del_btn"> <i
					class="icon-trash align-top bigger-125"></i>删除该类型
				</a>
			...
			<form method="post" class="form form-horizontal" id="form-type-data">
				<div class="Operate_cont clearfix">
					...
					<div class="formControls ">
						<input type="text" class="input-text" value="${productType.name}"
							id="name" name="name" placeholder="长度不超过50个字符"> <span
							class="help-block"></span> <input type="hidden" name="parentid"
							value="${productType.parentid}"> <input type="hidden"
							name="id" value="${productType.id}" id="typeId">
					</div>
				</div>
				<div class="Operate_cont clearfix">
					...
					<div class="formControls ">
						<input type="number" class="input-text"
							value="${productType.sort}" id="sort" name="sort"
							placeholder="请输入排序数字"> <span class="help-block"></span>
					</div>
				</div>
				<div class="Operate_cont clearfix">
					...
					<div class="formControls">
						...
						<p class="textarea-numberbar">
							<em class="textarea-length">0</em>/100 <span class="help-block"
								id="remark_msg"></span>
						</p>
					</div>
				</div>
				<div class="">
					<div class="" style=" text-align:center">
						<input class="btn btn-primary radius" type="button" value="确定修改"
							id="edit_btn"> <br>
						<br>
						<font id="msg"></font>
					</div>
			...
			<form action="" method="post" class="form form-horizontal"
				...
				<ul class="list-group">
					<li class="list-group-item"><input type="button"
						class="btn  btn-warning" value="返回" id="control_btn">
				...
				<div class="Operate_cont clearfix">
					...
					<div class="formControls ">
						<input type="text" class="input-text" placeholder="不能超过50个字符"
							name="name" id="name1"> <span class="help-block"></span>
						<input type="hidden" name="parentid" id="parentid"
							value="${productType.id}"> <input type="hidden"
							name="grade" value="${productType.grade+1}">
					</div>
				</div>
				<div class="Operate_cont clearfix">
					<label class="form-label"><font color="red">*</font>排序：</label>
					<div class="formControls ">
						<input type="number" class="input-text" placeholder="请输入排序数字"
							name="sort" id="sort1"> <span class="help-block"></span>
					</div>
				</div>
				<div class="Operate_cont clearfix">
					<label class="form-label"><font color="red">*</font>备注：</label>
				...
				<div class="">
					<div class="" style=" text-align:center">
						<input class="btn btn-primary radius" type="button" value="确定新增"
							id="add_childType_btn"> <br>
						<br>
						<font id="add_msg"></font>
					</div>
				</div>
			</form>
	...
	<script type="text/javascript"
		src="${APP_PATH}/static/shop/assets/layer/layer.js"></script>
		...
		$("#name")
				.change(
						function() {
							...
							$
									.ajax({
										url : "${APP_PATH}/productType/update_checkName.action?name="
												+ name + "&id=" + id,
										type : "POST",
										success : function(result) {
											if (result.code != 100) {
		...
		$("#name1")
				.change(
						function() {
							...
							$
									.ajax({
										url : "${APP_PATH}/productType/add_checkName.action?name="
												+ name,
										type : "POST",
										success : function(result) {
											if (result.code != 100) {
