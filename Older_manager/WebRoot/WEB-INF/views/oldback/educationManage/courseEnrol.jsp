				...
				<form class="form-inline">
					...
					<div class="form-group">
						<label for="exampleInputEmail2">讲师</label> <input type="text"
							class="form-control" placeholder="请输入讲师姓名">
					</div>
					<div class="form-group">
					...
					<form class="form-horizontal">
						<table class="table table-striped table-bordered text-center">
							...
							<tr>
								...
								<td rowspan="3" colspan="2"><input class="btn btn-success"
									type="button" value="上传图片"> <img
							...
							<tr>
								<td>备注</td>
								<td colspan="3"><textarea class="form-control" rows="3"></textarea>
								</td>
							</tr>
						</table>
					</form>
				...
				<div class="modal-body">
					<form class="form-horizontal">
						<table class="table table-striped table-bordered text-center">
							<tr>
								<td>课程名称</td>
								<td class="col-xs-2">中医经络芳疗认证课</td>
								<td>老人姓名</td>
								<td class="col-xs-2">
									<p>李成全</p>
								</td>
